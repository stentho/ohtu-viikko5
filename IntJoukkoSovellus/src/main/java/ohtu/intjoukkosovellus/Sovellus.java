...
public class Sovellus {
    ...
    private static void lisaa() {
        ...
        joukko.lisaaJoukkoonLuku(lisLuku);
        return;
    ...
    private static void yhdiste() {
        ...
        bJoukko = mikaJoukko();
        c = IntJoukko.yhdisteJoukoista(aJoukko, bJoukko);
    ...
    private static void leikkaus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.leikkausJoukoista(aJoukko, bJoukko);
    ...
    private static void erotus() {
        ...
        System.out.print("2. joukko? ");
        bJoukko = mikaJoukko();
        c = IntJoukko.erotusJoukoista(aJoukko, bJoukko);
    ...
    private static void poista() {
        ...
        lisLuku = lukija.nextInt();
        joukko.poistaJoukostaLuku(lisLuku);
        return;
    }
